...
exports.getAccessoryTypeByNodeProfile = (nodeProfile) => {
  let accessoryType;
  ...
  switch (nodeProfile) {
    ...
    case ENUMS.CANodeProfile.CANodeProfileFloodDetectorWithTemperatureAndHumiditySensor:
      ...
      break;
    case ENUMS.CANodeProfile.CANodeProfileGarageDoorOperator:
    case ENUMS.CANodeProfile.CANodeProfileGarageDoorImpulseOperator:
